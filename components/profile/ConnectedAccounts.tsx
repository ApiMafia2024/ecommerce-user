...
export function ConnectedAccounts() {
  ...
  return (
    <div className="mt-8 bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-800 p-6 sm:p-8 shadow-sm">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500">
                {t("profile.connectedAccounts.connectedTo", { email: "alex.j@gmail.com" })}
              </p>
            </div>
          </div>
        ...
        <div className="flex items-center justify-between p-4 bg-slate-50 dark:bg-slate-900/30 rounded-xl">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500">{t("profile.connectedAccounts.notConnected")}</p>
            </div>
          </div>
